 ...
 */
 ...
 app.get("/crm/api/v1/users/",[authJwt.verifyToken,authJwt.isAdmin],userController.getAllUsers);


 /**
  * GET 127.0.0.1:80801/crm/api/v1/users/{}
  */
 app.get("/crm/api/v1/users/:userId",[authJwt.verifyToken],userController.findUserById);


 /**
  * PUT 127.0.0.1:8081/crm/api/v1/users/{}
  */
